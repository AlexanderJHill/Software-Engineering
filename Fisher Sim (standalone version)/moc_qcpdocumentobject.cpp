...
#include "../../../../Documents/Software-Engineering/CrowdAnalysys/qcpdocumentobject.h"
...
struct qt_meta_stringdata_QCPDocumentObject_t {
    QByteArrayData data[1];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QCPDocumentObject_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QCPDocumentObject_t qt_meta_stringdata_QCPDocumentObject = {
    {
QT_MOC_LITERAL(0, 0, 17) // "QCPDocumentObject"
...
const QMetaObject QCPDocumentObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QCPDocumentObject.data,
      qt_meta_data_QCPDocumentObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QCPDocumentObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QCPDocumentObject.stringdata))
