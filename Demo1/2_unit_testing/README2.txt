...
3. Run a Visual Studio command prompt as administrator (for example 'VS2013 x64 Native Tools Command Prompt')

4. Navigate to the unit test directory.

5. Input these commands:
/myTestDirectory$ qmake -project "QT += testlib widgets"
/myTestDirectory$ qmake
/myTestDirectory$ nmake
cd release
2_unit_testing.exe